...
//LGE_CHANGE_S [hee.seo@lge.com] 2011-03-02, common : suspend -> rollback cpu freq to slow down
#ifdef CONFIG_HAS_EARLYSUSPEND
static void cpufreq_early_suspend( struct early_suspend *h );
static void cpufreq_early_resume( struct early_suspend *h );
#endif 
//LGE_CHANGE_E [hee.seo@lge.com] 2011-03-02, common : suspend -> rollback cpu freq to slow down
...
static struct attribute *default_attrs[] = {
	...
	&scaling_boost_freq.attr,		// hee.seo.lge.com
	NULL
};
