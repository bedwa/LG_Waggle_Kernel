...
//LGE_CHANGE_S[taekeun1.kim@lge.com] 2010-12-21, P920 : fix for removing flickering
...
//LGE_CHANGE_S[taekeun1.kim@lge.com] 2010-12-21, P920
...
//LGE_CHANGE_S [taekeun1.kim@lge.com] 2011-04-30, P920: prevent tearing
...
static int omap_dss_mgr_apply(struct omap_overlay_manager *mgr)
{
	...
	//LGE_CHANGE_S [taekeun1.kim@lge.com] 2011-0-27, P920: barrier enable
...
//LGE_CHANGE_S [taekeun1.kim@lge.com] 2011-04-30, P920: prevent lock up
#if defined(CONFIG_MACH_LGE_COSMOPOLITAN)
	if (!dss_get_mainclk_state()) {
		DSSERR("mainclk disabled while trying"
			"mgr_apply, returning\n");
