		...
		const char *buf, size_t size)
{
	...
	/* LGE_CHANGE_S [wonki.choi@lge.com] HDMI irq queueing 2011-4-15*/
...
//	}
	...
	/* LGE_CHANGE_E [wonki.choi@lge.com] 2011-4-15 */
...
int dss_mainclk_state_disable(bool do_clk_disable)
{
	...
	if (r) {
		...
		if (do_clk_disable) {
			/* LGE_CHANGE_S [wonki.choi@lge.com] DSS Sync Problem Fix 2011-5-10*/
			...
			save_all_ctx();
			dss_mainclk_disable();
			/* LGE_CHANGE [wonki.choi@lge.com] DSS Sync Problem Fix 2011-5-10 */
