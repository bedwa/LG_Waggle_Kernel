...
// LGE_CHANGE [jongho3.lee@lge.com] add writable attribute gauge_control. start.
...
// LGE_CHANGE [jongho3.lee@lge.com] add writable attribute gauge_control. end.
	...
	for (i = 0; i < psy->num_properties; i++) {
		...
		if (property == attrno) {
			if (psy->property_is_writeable &&
				...
				//FIXME: [jongho3.lee@lge.com] it should be writable by only ril group..
