...
#if defined(CONFIG_LG_FW_MAX17043_FUEL_GAUGE)
	//LGE_CHANGE <jongho3.lee@lge.com> we need to set rcomp value with temp..
	{
...
//#if defined(CONFIG_LG_FW_MAX17040_FUEL_GAUGE)
		...
		//LGE_CHANGE_S <jongho3.lee@lge.com> set capacity to 100 if capacity is 0 while factory charging.
