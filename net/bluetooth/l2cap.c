...
static int l2cap_streaming_send(struct sock *sk)
{
 ...
 // teddy.ju@lge.com 20110119 WBT [START]
		if(tx_skb == NULL)
		{
			BT_DBG("l2cap_streaming_send - error tx_skb is null");
			return 0;
		}
 // teddy.ju@lge.com 20110119 WBT [END]		
...
static int l2cap_parse_conf_rsp(struct sock *sk, void *rsp, int len, void *data, u16 *result)
{
	...
	memset(&rfc, NULL, sizeof(rfc)); // teddy.ju@lge.com 20110119 WBT
...
static void l2cap_conf_rfc_get(struct sock *sk, void *rsp, int len)
{
	...
	case L2CAP_MODE_STREAMING:
		pi->mps    = le16_to_cpu(rfc.max_pdu_size);
	default:// teddy.ju@lge.com 20110119 WBT
		break;
	}
}
