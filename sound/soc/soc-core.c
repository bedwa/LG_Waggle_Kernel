...
// FIXME LGE DEV4 CH.PARK@LGE.COM 20101212 VOICECALL_NO_SUSPEND
static int s_bsuspend = 0;
// FIXME LGE LAB4 CH.PARK@LGE.COM 20110216 FM_RADIO_TEMP_ 
...
#if defined(CONFIG_MACH_LGE_COSMOPOLITAN) /* LGE_CHANGE_S [ty.lee@lge.com] 2010-09-13, write function of codec register  */
...
static DEVICE_ATTR(codec_reg, 0664, codec_reg_show, codec_reg_store);// LGE_CHANGE [ty.lee@lge.com] 2011-01-04, change permission
#else
static DEVICE_ATTR(codec_reg, 0444, codec_reg_show, NULL);
#endif /* LGE_CHANGE_E [ty.lee@lge.com]*/
...
int snd_soc_pcm_close(struct snd_pcm_substream *substream)
{
	...
	if (rtd->dai_link->no_pcm)
	{
		...
		if( rtd->be_active )	// LGE CH.PARK@LGE.COM 20101221 CLOSE_ERROR
			goto out;
	}
#endif	
...
// FIXME LGE DEV4 CH.PARK@LGE.COM 20101212 VOICECALL_NO_SUSPEND [START]
...
// FIXME LGE DEV4 CH.PARK@LGE.COM 20101212 VOICECALL_NO_SUSPEND [END]

// FIXME LGE LAB4 CH.PARK@LGE.COM 20110216 FM_RADIO_TEMP_ [START]
#if 1
...
#endif
// FIXME LGE LAB4 CH.PARK@LGE.COM 20110216 FM_RADIO_TEMP_ [END]
	...
	* suspend before that's finished - wait for it to complete.
	...
	if(s_partial_suspend==0){	// FIXME LGE LAB4 CH.PARK@LGE.COM 20110216 FM_RADIO_TEMP_ 
		if (card->suspend_pre)
...
// LGE LAB4 CH.PARK@LGE.COM 20110112 WBT
