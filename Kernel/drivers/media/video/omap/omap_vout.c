...
int omapvid_init(struct omap_vout_device *vout, u32 addr, u32 uv_addr)
{
	...
	for (i = 0; i < ovid->num_overlays; i++) {
		...
		posx = win->w.left;
		posy = win->w.top;
/* LGE_CHANGE_S [wonki.choi@lge.com] In V4L2 only consider virtual coord2011-1-8*/
#if 0
		switch (vout->rotation) {
		case dss_rotation_90_degree:
...
#endif
/* LGE_CHANGE_E [wonki.choi@lge.com] 2011-1-8 */
...
// 0112 DMA Priority modificatino for SPI from TI, eunae.kim@lge.com
...
/* LGE_CHANGE_S [wonki.choi@lge.com] 2010-12-30 HDMI*/
//	omap_vout_new_format(&vout->pix, &vout->fbuf, &vout->crop, &vout->win);
/* LGE_CHANGE_E [wonki.choi@lge.com] 2010-12-30 */
