		...
		u16 pic_height, bool wb_source)
{
	...
	if (rotation_type == OMAP_DSS_ROT_TILER) {
		...
		/* LGE_CHANGE [wonki.choi@lge.com] Overlay Refactoring 2011-1-24 */
...
static void _omap_dispc_initial_config(void)
{
	...
	/* LGE_CHANGE_S [wonki.choi@lge.com] 720P Play 2011-1-9*/
