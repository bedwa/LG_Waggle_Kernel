...
//LGE_CHANGE_S [hee.seo@lge.com] 2011-02-28, common : new dvfs policy, add api about cpu freq
#if 0
...
#endif
//LGE_CHANGE_E [hee.seo@lge.com] 2011-02-28, common : new dvfs policy, add api about cpu freq
	...
	if (avg_load < dbs_tuners_ins.down_threshold) {
		...
		if (policy->cur == policy->min) {
			...
			if (num_online_cpus() > 1 && hotplug_out_avg_load <
				...
				#if 1 	 	// 110125 jinhyeong.lee@lge.com MTBF spin lock issue while call ending 
				cpu_down(1);
				#endif
			}
			goto out;
