...
//LGE_CHANGE_S [kibum.lee@lge.com] 2011-01-06, common : temp off mode -> retention
//	pwrdm_set_next_pwrst(core_pwrdm, PWRDM_POWER_RET);
//	pwrdm_set_next_pwrst(mpu_pwrdm, PWRDM_POWER_RET);
//LGE_CHANGE_E [kibum.lee@lge.com] 2011-01-06, common : temp off mode -> retention
...
//COMMON_L1 changseok.kim@lge.com 20110206 OFF_GPIO_GLITCH [START]
...
static void Cosmo_padconf_save()
{
	...
	if(padindex==0)
	{
		...
		pad_save(	0x4A100120	,	127	);	// AUD_PWRON [hyunhee.jeon@lge.com]
		pad_save(	0x4A10013E	,	140	);	// GPS_LNA_SD [hyunhee.jeon@lge.com]
...
/*
		pad_save(	0x4A100184	,	0	);	// GPS_POWER_ON [hyunhee.jeon@lge.com]
		pad_save(	0x4A100186	,	1	);	// GPS_RESET_N
		pad_save(	0x4A1001AE	,	11	);	// UART_SW1 [hyunhee.jeon@lge.com]
		pad_save(	0x4A1001B0	,	12	);	// UART_SW2 [hyunhee.jeon@lge.com]
...
//COMMON_L1 changseok.kim@lge.com 20110206 OFF_GPIO_GLITCH [END]
...
static int omap4_pm_suspend(void)
{
	...
	u32 cpu1_state;
	// TI_CHANGE [MIPI-HSI] jaesung.woo@lge.com [END]
	//dennis.oh 2011-02-10 bt sleep [start]
	...
	//dennis.oh 2011-02-10 bt sleep [end]
	

	//COMMON_L1 changseok.kim@lge.com 20110206 OFF_GPIO_GLITCH
	Cosmo_padconf_save();
...
{
//LGE_CHANGE_S [david.seo@lge.com] 2011-03-26, common : move to twl driver
#if 0
	//GPADC_CTRL
...
#endif
//LGE_CHANGE_E [david.seo@lge.com] 2011-03-26, common : move to twl driver
