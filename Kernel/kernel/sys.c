...
//LGE S Change power on/off key 2010. 11. 10
#if CONFIG_ARCH_OMAP4
#include <plat/lge_err_handler.h>
#include <linux/i2c/twl.h>
#endif
//LGE E Change power on/off key 2010. 11. 10
...
{
#if CONFIG_ARCH_OMAP4
// LGE_ChangeS [Darren.Kang@lge.com] 2011.1.6 Changed for HW reset[ST]
...
//[jongho3.lee@lge.com] we need to skip writing nvdata in somecases.
	if(cmd == NULL || cmd[0] != 'U')
	{
		lge_user_reset();	
	}
...
// LGE_ChangeS [Darren.Kang@lge.com] 2011.1.6 Changed for HW reset[END]
#else
...
void kernel_halt(void)
{
   ...
   // kibum.lee@lge.com
	...
	disable_nonboot_cpus();					// kibum.lee@lge.com
	sysdev_shutdown();
