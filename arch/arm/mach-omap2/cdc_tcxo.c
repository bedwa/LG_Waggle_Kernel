				...
				const struct i2c_device_id *id)
{
	 ...
	 */
//LGE_CHANGE_S [david.seo@lge.com] 2011-01-21, common : Clock reference, VPMIC_VDAC current leakage
//	u8 buf[4] = {0x9f, 0xf0, 0, 0};
	u8 buf[4] = {0x9f, 0xf0, 0x20, 0x00};
//LGE_CHANGE_E [david.seo@lge.com] 2011-01-21, common : Clock reference, VPMIC_VDAC current leakage
